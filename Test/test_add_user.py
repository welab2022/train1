...
brower.get("http://127.0.0.1:5500/testrepo/Test/adduserpage.html")
sleep(2)
txt_fiName = brower.find_element(By.ID, "firstname")

txt_laName = brower.find_element(By.ID, "lastname")
# get id html username input
txt_user = brower.find_element(By.ID, "username")
#get id password
txt_password = brower.find_element(By.ID, "password")
#set username and password in website
txt_fiName.send_keys("admin")
txt_laName.send_keys("admin")
